...
export const GROCERY_CATEGORIES: ShoppingCategory[] = [
    ...
    { slug: 'cleaning-household', label: 'Cleaning & Household' },  { slug: 'coffee-tea-drink-mixes', label: 'Coffee, Tea & Drink Mixes' },    { slug: 'condiments-spices',  label: 'Condiments & Spices' },
