...
<script lang="ts">
    import {
        ArrowDown, ArrowUp, Bell, BookOpen, Box, Check, CheckCircle, ChevronDown, ChevronUp, CircleX,
        ChevronLeft, ChevronRight, CircleAlert, Clock, CornerDownRight,
        DatabaseBackup, Download, Eye, EyeOff, File, FileArchive, FileCog, FileSpreadsheet,
        Folder, Grid2x2, Home, House, Image, Inbox, Info, Link2Off, List,
        Loader, MapPin, Menu, MoreHorizontal,
    ...
    const ICON_MAP: Record<string, any> = {
        ...
        'bell': Bell, 'book-open': BookOpen, 'box': Box, 'check': Check,
        ...
        'map-pin': MapPin, 'menu': Menu, 'more-horizontal': MoreHorizontal,
