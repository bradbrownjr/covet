...
const REGISTERED_ICONS = new Set([
  ...
  'check-circle', 'circle-x',
  'chevron-left', 'chevron-right', 'circle-alert', 'corner-down-right',
  'database-backup', 'download',
  'file-archive', 'file-cog', 'file-spreadsheet',
  'folder', 'grid-2x2',
  'home', 'house', 'inbox', 'info', 'list',
  'link-2-off', 'loader',
  'map-pin', 'more-horizontal',
  'package', 'package-check', 'palette', 'party-popper', 'pencil',
  'settings', 'settings-2', 'share-2', 'shield', 'shopping-cart', 'sliders-horizontal',
  'sparkles', 'star', 'store',
