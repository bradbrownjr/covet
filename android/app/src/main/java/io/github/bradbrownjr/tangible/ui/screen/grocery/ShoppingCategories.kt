...
internal val SHOPPING_CATEGORY_PRESETS: List<ShoppingCategoryPreset> = listOf(
    ...
    ShoppingCategoryPreset("cleaning-household",  R.string.cat_cleaning_household),    ShoppingCategoryPreset("coffee-tea-drink-mixes", R.string.cat_coffee_tea_drink_mixes),    ShoppingCategoryPreset("condiments-spices",   R.string.cat_condiments_spices),
