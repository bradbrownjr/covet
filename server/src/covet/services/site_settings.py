...
Resolution order (highest to lowest):
  ...
  2. Environment variable (COVET_* or set via YAML overlay)
  3. Hardcoded default
...
MANAGED_SETTINGS: dict[str, _Meta] = {
    ...
    "registration_enabled": _Meta(
        ...
        env_var="COVET_REGISTRATION_ENABLED",
        default=True,
    ...
    "password_min_length": _Meta(
        ...
        env_var="COVET_PASSWORD_MIN_LENGTH",
        default=12,
    ...
    "session_ttl_hours": _Meta(
        ...
        env_var="COVET_SESSION_TTL_HOURS",
        default=720,
    ...
    "igdb_client_secret": _Meta(
        ...
        env_var="COVET_IGDB_CLIENT_SECRET",
        default=None,
    ...
    "google_books_api_key": _Meta(
        ...
        env_var="COVET_GOOGLE_BOOKS_API_KEY",
        default=None,
    ...
    "smtp_from": _Meta(
        type="str",
        env_attr="smtp_from",
        env_var="COVET_SMTP_FROM",
        default=None,
        description="From address used on outgoing emails (e.g. covet@example.com)",
        sensitive=False,
        section="email",
    ),
    "smtp_starttls": _Meta(
