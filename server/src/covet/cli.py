...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="covet", description="Covet server CLI")
    ...
    sub.add_parser("version", help="Print the installed Covet version")
...
def _cmd_backup(settings, username: str, output: str) -> None:
    ...
    from covet.importers import export_user
...
def _cmd_restore(settings, username: str, input_path: str) -> None:
    ...
    from covet.db import init_engine
    from covet.importers import import_backup
    from covet.models import User
